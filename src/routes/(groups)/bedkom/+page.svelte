...
<div class="text-center flex flex-col items-center justify-center gap-3 min-h-[70vh]">
	<div class="space-y-6">
		<h1 class="text-5xl font-bold">Søk verv i echo Bedkom</h1>
		<p class="max-w-md mx-auto text-neutral-200" />
		<ButtonLink class="w-fit mx-auto" href="/verv/bedkom" size="large"
...
<article class="space-y-4 text-lg pt-10 pb-4">
	...
	<h2 class="text-xl font-semibold pt-4">Hvorfor Bedkom?</h2>

	<h2 class="text-xl font-semibold pt-4">Hvorfor deg?</h2>

	<div>
		<ButtonLink class="w-full" href="/verv/bedkom">Søk her</ButtonLink>
	</div>
